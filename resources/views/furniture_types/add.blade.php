...
<div class="panel panel-default">
    ...
    @endif  
        ...
        <form action="{{ url('/furniture_types'.( isset($model) ? "/" . $model->furniture_type_id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
...
<!--
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" name="furniture_type_id" id="furniture_type_id" class="form-control" value="{{$model['furniture_type_id'] or ''}}">
                </div>
            </div>
-->			
			<input type="hidden" name="furniture_type_id" id="furniture_type_id" class="form-control" value="{{$model['furniture_type_id'] or ''}}">
             <div class="form-group">
                <label for="furniture_name" class="col-sm-3 control-label">Furniture Name</label>
                <div class="col-sm-6">
                    <input type="text" name="furniture_name" id="furniture_name" class="form-control" value="{{$model['furniture_name'] or ''}}">
                </div>
            </div>
            <div class="form-group">
