...
<div class="panel panel-default">
    ...
    @endif
        ...
        <form action="{{ url('/bathroom_types'.( isset($model) ? "/" . $model->bathroom_type_id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
...
<!--
              <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" name="bathroom_type_id" id="bathroom_type_id" class="form-control" value="{{$model['bathroom_type_id'] or ''}}">
                </div>
            </div>
-->
            <input type="hidden" name="bathroom_type_id" id="bathroom_type_id" class="form-control" value="{{$model['bathroom_type_id'] or ''}}">
            <div class="form-group">
                <label for="bathroom_type_name" class="col-sm-3 control-label">Bathroom Type Name</label>
                <div class="col-sm-6">
                    <input type="text" name="bathroom_type_name" id="bathroom_type_name" class="form-control" value="{{$model['bathroom_type_name'] or ''}}">
                </div>
            </div>
                <div class="form-group">
