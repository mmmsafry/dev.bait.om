...
<div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    @endif
        ...
        <form action="{{ url('/property_types'.( isset($model) ? "/" . $model->property_type_id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
           ...
           <!-- <div class="form-group">
			 ...
			 <input type="hidden" name="property_type_id" id="property_type_id" class="form-control" value="{{$model['property_type_id'] or ''}}">
                                                                                    <div class="form-group">
         ...
         <!--   <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/property_types') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                </div>
            </div>
        </form>
